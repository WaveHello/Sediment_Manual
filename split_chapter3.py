#!/usr/bin/env python3
"""Split Chapter 3 PDF into 5-page chunks."""
...
def split_pdf_into_chunks(input_path, output_dir, pages_per_chunk=5):
    ...
    print(f"Total pages in Chapter 3: {total_pages}")
    ...
    for chunk_num in range(num_chunks):
        ...
        # Save the chunk
        chunk_filename = f"chapter03_chunk_{chunk_num + 1:02d}_pages_{start_page + 1}-{end_page + 1}.pdf"
    ...
    doc.close()
    print(f"Successfully split Chapter 3 into {num_chunks} chunks")

if __name__ == "__main__":
    input_pdf = "chapters/Chapter_06_CHAPTER_3_TRANSPORT_OF_GRAVEL_AND_SEDIMENT_MIXTURES.pdf"
    output_directory = "chapters/chapter03_chunks"
